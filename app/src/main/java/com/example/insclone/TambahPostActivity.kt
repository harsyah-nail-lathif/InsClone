...
class TambahPostActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        when{
            imageUri == null -> Toast.makeText(this, "PLease Sellect your Image", Toast.LENGTH_SHORT).show()
            TextUtils.isEmpty(deskipsi_post.text.toString())-> Toast.makeText(this, "Please Write The Caption", Toast.LENGTH_SHORT).show()
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{task ->
                    ...
                    if(task.isSuccessful){
                        ...
                        postMap["description"] = deskipsi_post.text.toString().toLowerCase()
                        postMap["publisher"] = FirebaseAuth.getInstance().currentUser!!.uid
                        postMap["postImage"] = myUrl

                        ref.child(postId).updateChildren(postMap)
                        Toast.makeText(this, "Post Successed...", Toast.LENGTH_SHORT).show()
